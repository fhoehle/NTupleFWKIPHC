...
NTEvent::Reset ()
{
  ...
  GeneratedtausLepPlusDecays.clear ();
  GeneratedtausLepMinusDecays.clear ();
  GeneratedtausPionPlusDecays.clear ();
  GeneratedtausPionMinusDecays.clear ();

wPlusAndDecays.clear ();
wMinusAndDecays.clear ();

 topPlusAndDecays.clear ();
 topMinusAndDecays.clear ();
