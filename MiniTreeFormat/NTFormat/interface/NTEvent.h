...
namespace TopTree
{
  ...
  public:
    ...
    */
    ...
    int ptHat;
    std::pair<int,int> pdgIdPartons;/** pdgId of the initial partons */

    // ---- Trigger info 
    std::vector<std::pair<std::string, bool> > triggers;
    float match_HLT_Ele10_LW_L1R_recoEl;
    std::vector<std::pair<std::string, int> > prescales;
    ...
    std::vector < std::vector<TLorentzVector > >  GeneratedtausLepPlusDecays; 
    std::vector < std::vector<TLorentzVector > >  GeneratedtausLepMinusDecays; 
    std::vector < std::vector<TLorentzVector > >  GeneratedtausPionPlusDecays; 
    std::vector < std::vector<TLorentzVector > >  GeneratedtausPionMinusDecays;

    std::vector<WDecaysMC> wPlusAndDecays;
    std::vector<WDecaysMC> wMinusAndDecays;

    std::vector<TopDecaysMC> topPlusAndDecays;
    std::vector<TopDecaysMC> topMinusAndDecays;
