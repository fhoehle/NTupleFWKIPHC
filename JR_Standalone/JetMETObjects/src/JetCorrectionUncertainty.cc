...
std::vector<float> JetCorrectionUncertainty::fillVector(const std::vector<std::string>& fNames)
{
  ...
  for(unsigned i=0;i<fNames.size();i++)
    ...
    sserr<<"JetCorrectionUncertainty: jet eta is not set";
...
#ifdef STANDALONE 
    std::stringstream sserr;
    sserr<<"JetCorrectionUncertainty: jet pt is not set";
    throw std::runtime_error(sserr.str());
#else
...
#ifdef STANDALONE 
    std::stringstream sserr;
    sserr<<"JetCorrectionUncertainty: jet phi is not set";
    throw std::runtime_error(sserr.str());
#else
...
#ifdef STANDALONE 
    std::stringstream sserr;
    sserr<<"JetCorrectionUncertainty: jet energy is not set";
    throw std::runtime_error(sserr.str());
#else
...
#ifdef STANDALONE 
    std::stringstream sserr;
    sserr<<"JetCorrectionUncertainty: jet emf is not set";
    throw std::runtime_error(sserr.str());
#else
...
#ifdef STANDALONE 
    std::stringstream sserr;
    sserr<<"JetCorrectionUncertainty: lepton px is not set";
    throw std::runtime_error(sserr.str());
#else
...
#ifdef STANDALONE 
    std::stringstream sserr;
    sserr<<"JetCorrectionUncertainty: lepton py is not set";
    throw std::runtime_error(sserr.str());
#else
...
#ifdef STANDALONE 
    std::stringstream sserr;
    sserr<<"JetCorrectionUncertainty: lepton pz is not set";
    throw std::runtime_error(sserr.str());
#else
...
#ifdef STANDALONE 
    std::stringstream sserr;
    sserr<<"JetCorrectionUncertainty: unknown parameter "<<fNames[i];
    throw std::runtime_error(sserr.str());
#else
...
#ifdef STANDALONE 
    std::stringstream sserr;
    sserr<<"JetCorrectionUncertainty: not positive lepton-jet momentum: "<<lj2;
    throw std::runtime_error(sserr.str());
#else
