...
void TriggerCommissioning::CreateHistos(){
  ...
  //
  jet1_ref = new TH1F("jet1_ref","jet1_ref", 50, 0, 100);
  jet2_ref = new TH1F("jet2_ref","jet2_ref", 50, 0, 100);
  jet3_ref = new TH1F("jet3_ref","jet3_ref", 50, 0, 100);
  jet4_ref = new TH1F("jet4_ref","jet4_ref", 50, 0, 100);
 
  jet1_trig = new TH1F("jet1_trig","jet1_trig", 50, 0, 100);
  jet2_trig = new TH1F("jet2_trig","jet2_trig", 50, 0, 100);
  jet3_trig = new TH1F("jet3_trig","jet3_trig", 50, 0, 100);
  jet4_trig = new TH1F("jet4_trig","jet4_trig", 50, 0, 100);
  
  jet1_eff = new TH1F("jet1_eff","jet-leg efficiency vs pT", 50, 0, 100);
  jet2_eff = new TH1F("jet2_eff","jet-leg efficiency vs pT", 50, 0, 100);
  jet3_eff = new TH1F("jet3_eff","jet-leg efficiency vs pT", 50, 0, 100);
  jet4_eff = new TH1F("jet4_eff","jet-leg efficiency vs pT", 50, 0, 100);
  ...
  reference_tau= new TH1F("reference_tau","reference_tau", 15, x2bins);
  triggered_tau= new TH1F("triggered_tau","triggered_tau", 15, x2bins);
  ...
  eff_tau= new TH1F("eff_tau","eff_tau", 15, x2bins);
