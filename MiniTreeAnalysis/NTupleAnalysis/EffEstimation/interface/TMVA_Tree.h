...
class TMVA_Tree {
   ...
   public:
     ...
     void FillHistos(std::vector<NTJet> theJets, NTMET met,std::vector<NTMuon> selMuons, std::vector<NTElectron> selElectrons, std::vector<NTTau> theTausLoose, std::vector<NTTau> theTausMedium, bool passTriggerQuadJet40IsoPFtheTauselection, const float& weight);
