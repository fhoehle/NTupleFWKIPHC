...
class Selection{
   ...
   public:
      ...
      std::vector<NTJet> 	GetCleanJet(std::vector<NTJet> jet_cand,std::vector<NTMuon> muon_cand, std::vector<NTElectron> elec_cand) ;
      ...
      std::vector<NTJet>      GetSelectedJets(const std::vector<NTMuon> & muon_cand, const std::vector<NTElectron> & elec_cand, bool applyJES = false, float scale = 1., bool applyJER = false, float ResFactor = 0.) const;
      ...
      //std::vector<NTElectron> GetScaledElectrons(float scale, std::vector<NTElectron> newElectrons) const;
...
//      void InitSFBWeight(int flagb, int methodb, int systb);
      void InitSFBWeight (int flagb, int methodb, int systb, int btagAlgo, float btagDiscriCut, int btagNjets, string & file1, string & file2, string & file3);
      void ReInitSFBWeight (int flagb, int methodb, int systb, int btagAlgo, float btagDiscriCut, int btagNjets);
      void ResetParameters4Bweight(int flagb, int methodb, int systb, string & file1, string & file2, string & file3);
      int GetFlagb() const;
