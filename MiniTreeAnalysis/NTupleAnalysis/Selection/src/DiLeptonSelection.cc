	...
	bool applyJER, float JERFactor, bool applyMETS, float METScale)
{
  ...
  if (filterTTbarMC) {
	...
	step_Zveto = true;
      ...
      jetsAna = GetSelectedJets (muon_cand, elec_cand, applyJES, JESParam, applyJER, JERFactor);
	...
	step_jets = true;
      ...
      //Step 6  MET cuts
      if (applyMETS) metAna = GetUnclusScaledMET (true, METScale);
      else metAna = GetMET (applyJES, JESParam, applyJER, JERFactor);
      if (pairType_ == string ("emu")) {
	if (metAna.p4.Et () > METEMu) {
	  //FinalStep++;
	  step_met = true;
	}
      }
      else {
	if (metAna.p4.Et () > METLL) {
	  //FinalStep++;
	  step_met = true;
	}
      }
      ...
      if(step_jets){
      	jet1pt_oss << jetsAna[0].p4.Pt ();
      	jet2pt_oss << jetsAna[1].p4.Pt ();
      	jet1bdisc_oss << jetsAna[0].TCDiscri;
      	jet2bdisc_oss << jetsAna[1].TCDiscri;
	...
	if (passBtagSelection(jetsAna[j])) {
	  btagjets.push_back (jetsAna[j]);
	  btagDiscri.push_back (getBtagDiscr(jetsAna[j], btagAlgo_));
	}
      }
      bjetsAna = btagjets;
  ...
  if(!step_pair){
	...
	if (passBtagSelection(SelectedJets[j])) {
	  ...
	  btagDiscri.push_back (getBtagDiscr(SelectedJets[j], btagAlgo_));
	}
      }
      bjetsAna = btagjets;
      if (GetFlagb() == 1) {
...
//      if ((triggerList[i].first == "HLT_DoubleMu5_v1" && triggerList[i].second == true)) // Spring11
      if ((triggerList[i].first == "HLT_DoubleMu6_v1" && triggerList[i].second == true) //Summer11
          || (triggerList[i].first == "HLT_DoubleMu6_v8" && triggerList[i].second == true) // fall 11
...
//      if ((triggerList[i].first == "HLT_Ele17_SW_TightCaloEleId_Ele8HE_L1R_v2" && triggerList[i].second ==true )) //Spring11
      ...
      || (triggerList[i].first == "HLT_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v8" && triggerList[i].second == true )//Fall11
      ) //Summer11
	passEl = true;
...
// Summer11
	if( ((triggerList[i].first == "HLT_Mu8_Ele17_CaloIdL_v2" ) || (triggerList[i].first == "HLT_Mu10_Ele10_CaloIdL_v3" ) //Summer11
	 || (triggerList[i].first == "HLT_Mu8_Ele17_CaloIdL_v9") ) && triggerList[i].second == true) //Fall11
	passElMu = true;
...
///////////////////////double muon channel  ///////////////////////
      ...
      if ( runNumber <= 165208 ) {
         if( (triggerList[i].first == "HLT_DoubleMu7_v1") && triggerList[i].second == true)   passMu = true; 
         if( (triggerList[i].first == "HLT_DoubleMu7_v2") && triggerList[i].second == true)   passMu = true; 
      }           
      if (  runNumber  >= 165209 && runNumber  <=178419){
       if( (triggerList[i].first == "HLT_Mu13_Mu8_v2") && triggerList[i].second == true) passMu = true;  
       if( (triggerList[i].first == "HLT_Mu13_Mu8_v3") && triggerList[i].second == true) passMu = true; 
       if( (triggerList[i].first == "HLT_Mu13_Mu8_v4") && triggerList[i].second == true) passMu = true; 
       if( (triggerList[i].first == "HLT_Mu13_Mu8_v5") && triggerList[i].second == true) passMu = true; 
       if( (triggerList[i].first == "HLT_Mu13_Mu8_v6") && triggerList[i].second == true) passMu = true; 
       if( (triggerList[i].first == "HLT_Mu13_Mu8_v7") && triggerList[i].second == true) passMu = true;         
      }
      if (  runNumber  >= 178420 && runNumber  <=999999 ){
        if(triggerList[i].first == "HLT_Mu17_Mu8_v10" && triggerList[i].second == true) passMu = true;   
        if(triggerList[i].first == "HLT_Mu17_Mu8_v11" && triggerList[i].second == true) passMu = true;      
      }
      if (  runNumber  >= 178420 && runNumber  <=999999){
        if(triggerList[i].first == "HLT_Mu17_TkMu8_v3" && triggerList[i].second == true) passMu = true;    
        if(triggerList[i].first == "HLT_Mu17_TkMu8_v4" && triggerList[i].second == true) passMu = true; 
      }
...
///////////////////////double electron channel  ///////////////////////
      ...
      && (   (triggerList[i].first == "HLT_Ele17_CaloIdL_CaloIsoVL_Ele8_CaloIdL_CaloIsoVL_v1" && triggerList[i].second == true)
          ...
          || (triggerList[i].first == "HLT_Ele17_CaloIdL_CaloIsoVL_Ele8_CaloIdL_CaloIsoVL_v7" && triggerList[i].second == true) 
          || (triggerList[i].first == "HLT_Ele17_CaloIdL_CaloIsoVL_Ele8_CaloIdL_CaloIsoVL_v8" && triggerList[i].second == true) 
      ...
      && (   (triggerList[i].first == "HLT_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v6"  && triggerList[i].second == true)
          ...
          || (triggerList[i].first == "HLT_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v9"  && triggerList[i].second == true) 
          || (triggerList[i].first == "HLT_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v10" && triggerList[i].second == true) 
...
///////////////////////e mu channel  ///////////////////////
      ...
      && ( 
           (triggerList[i].first == "HLT_Mu17_Ele8_CaloIdL_v1" && triggerList[i].second == true) 
         ||(triggerList[i].first == "HLT_Mu17_Ele8_CaloIdL_v2" && triggerList[i].second == true) 
         ||(triggerList[i].first == "HLT_Mu17_Ele8_CaloIdL_v3" && triggerList[i].second == true) 
         ||(triggerList[i].first == "HLT_Mu17_Ele8_CaloIdL_v4" && triggerList[i].second == true) 
         ||(triggerList[i].first == "HLT_Mu17_Ele8_CaloIdL_v5" && triggerList[i].second == true) 
         ||(triggerList[i].first == "HLT_Mu17_Ele8_CaloIdL_v6" && triggerList[i].second == true) 
         ||(triggerList[i].first == "HLT_Mu17_Ele8_CaloIdL_v7" && triggerList[i].second == true) 
         ||(triggerList[i].first == "HLT_Mu17_Ele8_CaloIdL_v8" && triggerList[i].second == true) 
         ||(triggerList[i].first == "HLT_Mu17_Ele8_CaloIdL_v9" && triggerList[i].second == true) 
      ...
      if ( runNumber  >= 175973  
      && ( 
           (triggerList[i].first == "HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_v4" && triggerList[i].second == true)  
         ||(triggerList[i].first == "HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_v7" && triggerList[i].second == true) 
         ||(triggerList[i].first == "HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_v8" && triggerList[i].second == true) 
      ...
      if (  runNumber  <= 167913 
      && ( 
           (triggerList[i].first == "HLT_Mu8_Ele17_CaloIdL_v1" && triggerList[i].second == true)  
         ||(triggerList[i].first == "HLT_Mu8_Ele17_CaloIdL_v2" && triggerList[i].second == true) 
         ||(triggerList[i].first == "HLT_Mu8_Ele17_CaloIdL_v3" && triggerList[i].second == true) 
         ||(triggerList[i].first == "HLT_Mu8_Ele17_CaloIdL_v4" && triggerList[i].second == true) 
         ||(triggerList[i].first == "HLT_Mu8_Ele17_CaloIdL_v5" && triggerList[i].second == true) 
         ||(triggerList[i].first == "HLT_Mu8_Ele17_CaloIdL_v6" && triggerList[i].second == true) 
      ...
      if ( runNumber  >=  167914 
      && ( 
           (triggerList[i].first == "HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_v3" && triggerList[i].second == true)  
         ||(triggerList[i].first == "HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_v4" && triggerList[i].second == true) 
         ||(triggerList[i].first == "HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_v7" && triggerList[i].second == true) 
         ||(triggerList[i].first == "HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_v8" && triggerList[i].second == true) 
...
std::pair<bool,bool> DiLeptonSelection::passMETTriggerSelection (Dataset * dataset)
{
  ...
  if (!dataset->isData ()) {	//MC
    //cout << " test trigger list --------------------------------" << endl;
    for (unsigned int i = 0; i < triggerList.size (); i++) {
       if(( (triggerList)[i].first == "HLT_CentralJet80_MET65_v1"  && (triggerList)[i].second == true)||
   	  ( (triggerList)[i].first == "HLT_CentralJet80_MET80_v1"  && (triggerList)[i].second == true)||
   	  ( (triggerList)[i].first == "HLT_CentralJet80_MET100_v1" && (triggerList)[i].second == true)||
   	  ( (triggerList)[i].first == "HLT_CentralJet80_MET160_v1" && (triggerList)[i].second == true)||
   	  ( (triggerList)[i].first == "HLT_DiJet60_MET45_v1"	   && (triggerList)[i].second == true)||
   	  ( (triggerList)[i].first == "HLT_PFMHT150_v2" 	   && (triggerList)[i].second == true)||
   	  ( (triggerList)[i].first == "HLT_MET100_v1"		   && (triggerList)[i].second == true)||
   	  ( (triggerList)[i].first == "HLT_MET120_v1"		   && (triggerList)[i].second == true)||
   	  ( (triggerList)[i].first == "HLT_MET200_v1"		   && (triggerList)[i].second == true) ){
          passTriggerMET = 1;
   	  if(
          ( (triggerList)[i].first == "HLT_BTagMu_DiJet20_Mu5_v2"  && (triggerList)[i].second == true)||
   	  ( (triggerList)[i].first == "HLT_BTagMu_DiJet60_Mu7_v2"  && (triggerList)[i].second == true)||
   	  ( (triggerList)[i].first == "HLT_BTagMu_DiJet80_Mu9_v2"  && (triggerList)[i].second == true)||
   	  ( (triggerList)[i].first == "HLT_BTagMu_DiJet100_Mu9_v2" && (triggerList)[i].second == true)) passTriggerBTAGMET = 1;
          }
     }
...
{
  return (getBtagDiscr(jet, btagAlgo_) >= btagDiscriCut_);
}
