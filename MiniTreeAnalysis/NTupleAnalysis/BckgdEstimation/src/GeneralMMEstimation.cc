...
void GeneralMMEstimation::CountNSel(DiLeptonSelection & sel_aux, Dataset dataset, SelectionTable selTable, unsigned int d, float weight, string CandTypeRequested, int selStepCut){
...
void GeneralMMEstimation::FillMMExpected(DiLeptonSelection & sel_aux, Dataset dataset, SelectionTable selTable, unsigned int d, float weight, string CandTypeRequested, int selStepCut, const NTEvent* event){
