...
class GeneralMMEstimation {
   ...
   public:
      ...
      void CountNSel(DiLeptonSelection&, Dataset, SelectionTable, unsigned int, float, string, int);
      void FillMMExpected(DiLeptonSelection&, Dataset, SelectionTable, unsigned int, float, string, int, const NTEvent*);
