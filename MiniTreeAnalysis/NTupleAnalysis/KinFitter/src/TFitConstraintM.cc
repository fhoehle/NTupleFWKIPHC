  ...
  ,_ParList2(0)
{
  ...
  if (Mass >= 0) {
    ...
    std::cout <<"NegativeMassConstr"
      << "Mass constraint in TFitConstraintM cannot be set to a negative value, will be set to 0."<<std::endl;
    _TheMassConstraint = 0.;
  }
}
...
void TFitConstraintM::print() {
  ...
  std::cout << "KinFitter " << this->getInfoString() << std::endl;
