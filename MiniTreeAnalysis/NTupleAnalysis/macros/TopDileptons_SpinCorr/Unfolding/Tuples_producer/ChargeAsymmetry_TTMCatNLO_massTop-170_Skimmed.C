...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmed_TTMCatNLO_massTop-170.root","RECREATE");
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_Skimmed_TTMCatNLO_massTop-170.root","RECREATE");
    //  fileCA->cd();
