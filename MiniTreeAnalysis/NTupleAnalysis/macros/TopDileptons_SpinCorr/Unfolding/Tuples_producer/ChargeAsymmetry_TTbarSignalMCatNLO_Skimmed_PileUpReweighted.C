...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmed_TTbarSignalMCatNLO_PileUpReweighted.root","RECREATE");
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_Skimmed_TTbarSignalMCatNLO_PileUpReweighted.root","RECREATE");
    //  fileCA->cd();
