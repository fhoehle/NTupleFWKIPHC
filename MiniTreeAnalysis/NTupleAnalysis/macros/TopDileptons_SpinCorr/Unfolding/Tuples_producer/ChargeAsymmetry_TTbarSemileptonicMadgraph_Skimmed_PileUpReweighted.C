...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmed_TTbarSemileptonicMadgraph_PileUpReweighted.root","RECREATE");
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_Skimmed_TTbarSemileptonicMadgraph_PileUpReweighted.root","RECREATE");
    //  fileCA->cd();
