...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmed_TTbarSignalMadgraph_LeptonSelEffNegLeptonWithMinus.root","RECREATE");
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_Skimmed_TTbarSignalMadgraph_LeptonSelEffNegLeptonWithMinus.root","RECREATE");
    //  fileCA->cd();
