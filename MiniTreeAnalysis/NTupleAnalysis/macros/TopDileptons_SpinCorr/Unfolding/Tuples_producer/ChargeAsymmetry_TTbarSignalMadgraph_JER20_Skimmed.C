...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmed_TTbarSignalMadgraph_JER20.root","RECREATE");
...
// Standard parameters for doFullSelection:
    ...
    bool applyJER = true; float JERFactor = 0.20; 
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_Skimmed_TTbarSignalMadgraph_JER20.root","RECREATE");
    //  fileCA->cd();
