...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmed_TTbarSignalMadgraph_LESdown.root","RECREATE");
...
// Standard parameters for doFullSelection:
    ...
    bool applyEEScale = true; float EEScaleParam = 0.997; bool applyEEResol = true; float EEResolParam = 0.997;
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_Skimmed_TTbarSignalMadgraph_LESdown.root","RECREATE");
    //  fileCA->cd();
