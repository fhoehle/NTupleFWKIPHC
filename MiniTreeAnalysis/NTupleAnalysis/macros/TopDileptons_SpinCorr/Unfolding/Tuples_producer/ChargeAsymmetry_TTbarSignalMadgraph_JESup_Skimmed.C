...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmed_TTbarSignalMadgraph_JESup.root","RECREATE");
...
// Standard parameters for doFullSelection:
    ...
    bool applyJES = true; float JESParam = 1.06;
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_Skimmed_TTbarSignalMadgraph_JESup.root","RECREATE");
    //  fileCA->cd();
