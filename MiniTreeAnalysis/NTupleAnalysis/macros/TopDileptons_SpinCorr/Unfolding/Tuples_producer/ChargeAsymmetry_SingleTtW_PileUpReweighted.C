...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmed_SingleTtW_PileUpReweighted.root","RECREATE");
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_SingleTtW_PileUpReweighted.root","RECREATE");
    //  fileCA->cd();
