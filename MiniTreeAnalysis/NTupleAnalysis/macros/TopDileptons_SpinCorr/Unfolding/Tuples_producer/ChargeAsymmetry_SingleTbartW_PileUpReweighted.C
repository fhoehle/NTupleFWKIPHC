...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmed_SingleTbartW_PileUpReweighted.root","RECREATE");
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_SingleTbartW_PileUpReweighted.root","RECREATE");
    //  fileCA->cd();
