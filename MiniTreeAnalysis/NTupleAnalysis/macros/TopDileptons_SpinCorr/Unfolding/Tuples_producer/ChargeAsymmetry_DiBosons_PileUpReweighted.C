...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmed_DiBosons_PileUpReweighted.root","RECREATE");
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_DiBosons_PileUpReweighted.root","RECREATE");
    //  fileCA->cd();
