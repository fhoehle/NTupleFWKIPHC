...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmed_TTbarSignalMadgraph_JESdown.root","RECREATE");
...
// Standard parameters for doFullSelection:
    ...
    bool applyJES = true; float JESParam = 0.94;
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_Skimmed_TTbarSignalMadgraph_JESdown.root","RECREATE");
    //  fileCA->cd();
