...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmed_WJets_signInverted.root","RECREATE");
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_WJets_signInverted.root","RECREATE");
    //  fileCA->cd();
