...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmed_TTbarSignalMadgraph_METdown.root","RECREATE");
...
// Standard parameters for doFullSelection:
    ...
    bool applyMETS = true; float METScale = 0.98;
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_Skimmed_TTbarSignalMadgraph_METdown.root","RECREATE");
    //  fileCA->cd();
