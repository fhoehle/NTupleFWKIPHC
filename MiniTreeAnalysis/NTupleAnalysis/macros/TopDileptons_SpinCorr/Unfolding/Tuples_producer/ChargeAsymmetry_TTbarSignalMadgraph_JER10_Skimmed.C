...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmed_TTbarSignalMadgraph_JER10.root","RECREATE");
...
// Standard parameters for doFullSelection:
    ...
    bool applyJER = true; float JERFactor = 0.10; 
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_Skimmed_TTbarSignalMadgraph_JER10.root","RECREATE");
    //  fileCA->cd();
