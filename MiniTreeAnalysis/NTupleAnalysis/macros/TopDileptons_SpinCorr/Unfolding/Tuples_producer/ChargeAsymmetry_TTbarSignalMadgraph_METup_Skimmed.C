...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmed_TTbarSignalMadgraph_METup.root","RECREATE");
...
// Standard parameters for doFullSelection:
    ...
    bool applyMETS = true; float METScale = 1.02;
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_Skimmed_TTbarSignalMadgraph_METup.root","RECREATE");
    //  fileCA->cd();
