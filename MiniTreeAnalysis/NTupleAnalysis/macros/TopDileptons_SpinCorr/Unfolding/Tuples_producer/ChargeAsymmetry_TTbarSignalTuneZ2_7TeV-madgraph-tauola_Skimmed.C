...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmed_TTbarSignalTuneZ2_7TeV-madgraph-tauola.root","RECREATE");
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_Skimmed_TTbarSignalTuneZ2_7TeV-madgraph-tauola.root","RECREATE");
    //  fileCA->cd();
