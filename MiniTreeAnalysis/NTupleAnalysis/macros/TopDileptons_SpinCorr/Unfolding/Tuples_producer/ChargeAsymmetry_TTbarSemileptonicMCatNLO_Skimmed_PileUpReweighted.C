...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmed_TTbarSemileptonicMCatNLO_PileUpReweighted.root","RECREATE");
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_Skimmed_TTbarSemileptonicMCatNLO_PileUpReweighted.root","RECREATE");
    //  fileCA->cd();
