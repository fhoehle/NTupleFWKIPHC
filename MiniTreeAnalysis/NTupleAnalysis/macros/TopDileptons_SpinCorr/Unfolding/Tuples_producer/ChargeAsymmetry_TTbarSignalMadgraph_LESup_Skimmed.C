...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmed_TTbarSignalMadgraph_LESup.root","RECREATE");
...
// Standard parameters for doFullSelection:
    ...
    bool applyEEScale = true; float EEScaleParam = 1.003; bool applyEEResol = false; float EEResolParam = 1.;
    bool applyMEScale = true; float MEScaleParam = 1.003; bool applyMEResol = false; float MEResolParam = 1.;
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_Skimmed_TTbarSignalMadgraph_LESup.root","RECREATE");
    //  fileCA->cd();
