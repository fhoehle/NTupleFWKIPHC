...
// fixme: Depracated
  ...
  TFile * TupleFile = new TFile("TupleFileSkimmedDATA2011AB_LeptonAsymmetry.root","RECREATE");
...
//  }
    ...
    TFile * fileCA = new TFile("ChargeAsymmetryResults_DATA2011AB_LeptonAsymmetry.root","RECREATE");
    //  fileCA->cd();
