...
string("/opt/sbg/data/safe1/cms/jandrea/TTbarSpinCorrelation_7TeV/CMSSW_4_2_8_patch7/src/MiniTreeAnalysis/NTupleAnalysis/config/MyCutFlow_2011AB_NoSpinCorr.xml");  
string outputFileName = "proof.root";
  ...
  system("mkdir backup_outputProof`date +\"%d-%m-%y_%H-%M-%S\"`; sleep 20 ; mv proof*.root  ttbar_mcatnlo_NoSC_PDF.root");
