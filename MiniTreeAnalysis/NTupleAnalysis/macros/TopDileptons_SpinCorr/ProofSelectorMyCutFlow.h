...
class ProofSelectorMyCutFlow : public TSelector {
 public :
  ...
  //
  TH1F* mcEventWeightHist; 
  TH1F * tauPolReweightHistForMCatNLO;
  bool tauPolReweighting; 
  bool TreeNotAlreadyFilled;
  double deltaPhiGen, deltaPhiRec,totalEventWeight,ttbarGen,ttbarRec;
  //
  TTree * TupleTreeUnfolding;
  TTree * TupleTreeBeforeSelection;

  //
  TF1 * tauPolLepEnergyDist;
  TF1 * topPtMcWeightFunc;
  
  //
  std::vector<TH1F>  DeltaPhiLLept_mumu_afterbtag1_tauPolReweighted;
  std::vector<TH1F>  DeltaPhiLLept_emu_afterbtag1_tauPolReweighted;
  std::vector<TH1F>  DeltaPhiLLept_ee_afterbtag1_tauPolReweighted;

  std::vector<TH1F>  DeltaPhiLLept_topPtReweighted_emu_afterbtag1;
  std::vector<TH1F>  DeltaPhiLLept_topPtReweighted_mumu_afterbtag1;
  std::vector<TH1F>  DeltaPhiLLept_topPtReweighted_ee_afterbtag1;
  
  std::vector<TH1F>    tauPol_pion;
  std::vector<TH1F>  tauPol_lep;
  std::vector<TH1F>  tauPolReweighted_lep;
  std::vector<TH1F>  tauPolWeights_lep;

  std::vector<TH1F>  tauPolWeights_ee_afterbtag1;
  std::vector<TH1F>  tauPolWeights_emu_afterbtag1;
  std::vector<TH1F>  tauPolWeights_mumu_afterbtag1;
...
//  std::vector<TH1F>
  ...
  int neventsel, neventsel_recofailure, neventsel_selfailure;

  ////////////////////////////////////
  // beginning block with histos added by script
  ////////////////////////////////////
  std::vector<TH1F> ptWheightsUsed_mumu_after1btag;//addedBy_addHistToFWK.sh_130521_120454
  std::vector<TH1F> ptWheightsUsed_emu_after1btag;//addedBy_addHistToFWK.sh_130521_121514
  std::vector<TH1F> ptWheightsUsed_ee_after1btag;//addedBy_addHistToFWK.sh_130521_121654
  //nextHistWillBeAddedHereDeclaration
  /////////////////////
  // end of block of histos added by script
  /////////////////////////////////
  ...
  //
  TLorentzVector getBoostedPionInWFrame(TLorentzVector part,TLorentzVector RestParticle);
