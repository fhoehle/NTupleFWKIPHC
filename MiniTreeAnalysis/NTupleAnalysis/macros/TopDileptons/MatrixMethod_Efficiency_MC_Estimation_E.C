...
int main ()
{
  ...
  */
   ...
   unsigned int nEvents = (int) (datasets[d].eventTree ()->GetEntries ());
    ...
    for (unsigned int ievt = 0; ievt < nEvents; ievt++){
      ...
      if(thePUReweighter.getUseOutOfTimePU()){
       ...
       if(/*(datasets[d].Name() == "TTbar" && (*/event->TMEME == 2 || event->TMEME == 10101 || event->TMEME == 20200/*)) ||*/ // ee
          /*datasets[d].Name() == "Zjets"*/){

       if(electrons.size() == 2 && sel.passTriggerSelection ( &datasets[d], "ee")){
        for(unsigned int i=0; i<electrons.size(); i++){
	  if(electrons[i].RelIso03PF() < 0.8) loose_iso_counter_eff += 1;
	  if(electrons[i].RelIso03PF() < 0.17) tight_iso_counter_eff += 1;
	}
       }

       if(loose_iso_counter_eff == 2){
                  IsoLooseForEfficiencyNJets->Fill(jets_Loose.size(),weight);
                  IsoLooseForEfficiencyEta->Fill(electrons[0].p4.Eta(),weight);
                  IsoLooseForEfficiencyPT->Fill(electrons[0].p4.Perp(),weight);
                  Unweighted_IsoLooseForEfficiencyNJets->Fill(jets_Loose.size());
                  Unweighted_IsoLooseForEfficiencyEta->Fill(electrons[0].p4.Eta());
                  Unweighted_IsoLooseForEfficiencyPT->Fill(electrons[0].p4.Perp());

       }
       if(tight_iso_counter_eff == 2){
                  IsoTightForEfficiencyNJets->Fill(jets_Tight.size() , weight);
                  IsoTightForEfficiencyEta->Fill(electrons[0].p4.Eta(),weight);
                  IsoTightForEfficiencyPT->Fill(electrons[0].p4.Perp(),weight);
                  Unweighted_IsoTightForEfficiencyNJets->Fill(jets_Tight.size());
                  Unweighted_IsoTightForEfficiencyEta->Fill(electrons[0].p4.Eta());
                  Unweighted_IsoTightForEfficiencyPT->Fill(electrons[0].p4.Perp());
       }
       }


       if(/*(datasets[d].Name() == "TTbar" && (*/event->TMEME == 1 || /*event->TMEME == 10 ||*/ // l(=e)jets
                                             event->TMEME == 11 || event->TMEME == 11001 || event->TMEME == 10110 || event->TMEME == 21100 || // emu
                                             /*event->TMEME == 10010 ||*/ event->TMEME == 10001 || // l(=e)tau(->had)
	                                     event->TMEME == 10100 /*|| event->TMEME == 11000*//*)) ||*/ // tau(->e/mu)jets
	  /*datasets[d].Name() == "Wjets"*/){

       if(electrons.size() == 2 && sel.passTriggerSelection ( &datasets[d], "ee")){
        for(unsigned int i=0; i<electrons.size(); i++){
	  if(electrons[i].RelIso03PF() < 0.8) loose_iso_counter_fake += 1;
	  if(electrons[i].RelIso03PF() < 0.17) tight_iso_counter_fake += 1;
	}
       }

       if(loose_iso_counter_fake == 2){
                  IsoLooseForFakeRateNJets->Fill(jets_Loose.size(),weight);
                  IsoLooseForFakeRateEta->Fill(electrons[0].p4.Eta(),weight);
                  IsoLooseForFakeRatePT->Fill(electrons[0].p4.Perp(),weight);
                  Unweighted_IsoLooseForFakeRateNJets->Fill(jets_Loose.size());
                  Unweighted_IsoLooseForFakeRateEta->Fill(electrons[0].p4.Eta());
                  Unweighted_IsoLooseForFakeRatePT->Fill(electrons[0].p4.Perp());
       }
       if(tight_iso_counter_fake == 2){
                  IsoTightForFakeRateNJets->Fill(jets_Tight.size(),weight);
                  IsoTightForFakeRateEta->Fill(electrons[0].p4.Eta(),weight);
                  IsoTightForFakeRatePT->Fill(electrons[0].p4.Perp(),weight);
                  Unweighted_IsoTightForFakeRateNJets->Fill(jets_Tight.size());
                  Unweighted_IsoTightForFakeRateEta->Fill(electrons[0].p4.Eta());
                  Unweighted_IsoTightForFakeRatePT->Fill(electrons[0].p4.Perp());
       }
       }
	  ...
	  if(electrons[i].RelIso03PF() < 0.17) tight_iso_counter_fake += 1;
       ...
       if(loose_iso_counter_fake == 2){
                  ...
                  IsoLooseForFakeRateEta_QCD->Fill(electrons[0].p4.Eta(),weight);
                  IsoLooseForFakeRatePT_QCD->Fill(electrons[0].p4.Perp(),weight);
                  Unweighted_IsoLooseForFakeRateNJets_QCD->Fill(jets_Loose.size());
                  Unweighted_IsoLooseForFakeRateEta_QCD->Fill(electrons[0].p4.Eta());
                  Unweighted_IsoLooseForFakeRatePT_QCD->Fill(electrons[0].p4.Perp());
       }
       if(tight_iso_counter_fake == 2){
                  IsoTightForFakeRateNJets_QCD->Fill(jets_Tight.size(),weight);
                  IsoTightForFakeRateEta_QCD->Fill(electrons[0].p4.Eta(),weight);
                  IsoTightForFakeRatePT_QCD->Fill(electrons[0].p4.Perp(),weight);
                  Unweighted_IsoTightForFakeRateNJets_QCD->Fill(jets_Tight.size());
                  Unweighted_IsoTightForFakeRateEta_QCD->Fill(electrons[0].p4.Eta());
                  Unweighted_IsoTightForFakeRatePT_QCD->Fill(electrons[0].p4.Perp());
       }
       }
       */
  ...
  TFile* file_MM = new TFile("MatrixMethod_Efficiency_MC_E.root","RECREATE");
  file_MM->cd();
