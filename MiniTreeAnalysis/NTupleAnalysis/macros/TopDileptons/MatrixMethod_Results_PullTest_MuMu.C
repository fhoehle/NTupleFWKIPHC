MatrixMethod_Results_PullTest_MuMu(string selection, string eventType){
  ...
  TFile * file_Expected   = new TFile("MatrixMethod_OutPut_MuMuCase_MC_Fast_PullTest.root");
  TFile * file_Estimated  = new TFile("MatrixMethod_OutPut_MuMuCase_MC_Fast_PullTest.root");
  ...
  if( selection == "Tight"){
    ...
    if(eventType == "Signal"){
      TCanvas * canv = new TCanvas(("canvPullTest_MuMu_"+selection+eventType).c_str(), ("canvPullTest_MuMu_"+selection+eventType).c_str(), 600, 800);
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs("TightSignalMuMu_PullTest.pdf");
    }
    ...
    if(eventType == "Wlike"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs("TightWlikeMuMu_PullTest.pdf");
    }
    ...
    if(eventType == "QCDlike"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs("TightQCDMuMu_PullTest.pdf");      
    }
  ...
  if( selection == "Medium"){
    ...
    if(eventType == "Signal"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs("MediumSignalMuMu_PullTest.pdf");
    }
    ...
    if(eventType == "Wlike"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs("MediumWlikeMuMu_PullTest.pdf");      
    }
    ...
    if(eventType == "QCDlike"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs("MediumQCDMuMu_PullTest.pdf");      
    }
  ...
  if( selection == "Loose"){
    ...
    if(eventType == "Signal"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs("LooseSignalMuMu_PullTest.pdf");      
    }
    ...
    if(eventType == "Wlike"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs("LooseWlikeMuMu_PullTest.pdf");      
    }
    ...
    if(eventType == "QCDlike"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs("LooseQCDMuMu_PullTest.pdf");      
    }
