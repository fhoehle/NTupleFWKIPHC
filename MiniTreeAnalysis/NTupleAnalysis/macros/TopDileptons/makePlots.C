 ...
 // loop over channels
  ...
  //  loop for SetLogy option 
   ...
   for (int k=0; k<2; k++) {
    ...
    //PlotStack("PtJet1_", jchan, "_afterjetcut", i, k);
    //PlotStack("PtJet2_", jchan, "_afterjetcut", i, k);
    /*if(j==1){
    PlotStack("PtMu1_", jchan, "_afterjetcut", i, k);
    PlotStack("PtMu2_", jchan, "_afterjetcut", i, k);
    }

    if(j==0){
    PlotStack("PtEl1_", jchan, "_afterjetcut", i, k);
    PlotStack("PtEl2_", jchan, "_afterjetcut", i, k);
    }*/
