MatrixMethod_Results_EpsilonsTest_EE(string selection, string eventType){
  ...
  TFile * file_Estimated  = new TFile("MatrixMethod_OutPut_EECase_MC_Fast_EpsilonsTest.root");
  ...
  if( selection == "Tight"){
    ...
    if(eventType == "Signal"){
      TCanvas * canv = new TCanvas(("canvEpsilonsTest_EE_"+selection+eventType).c_str(), ("canvEpsilonsTest_EE_"+selection+eventType).c_str(), 600, 800);
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs("TightSignalEE_EpsilonsTest.pdf");
    }
    ...
    if(eventType == "Wlike"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs("TightWlikeEE_EpsilonsTest.pdf");
    }
    ...
    if(eventType == "QCDlike"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs("TightQCDEE_EpsilonsTest.pdf");      
    }
  ...
  if( selection == "Medium"){
    ...
    if(eventType == "Signal"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs("MediumSignalEE_EpsilonsTest.pdf");
    }
    ...
    if(eventType == "Wlike"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs("MediumWlikeEE_EpsilonsTest.pdf");      
    }
    ...
    if(eventType == "QCDlike"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs("MediumQCDEE_EpsilonsTest.pdf");      
    }
  ...
  if( selection == "Loose"){
    ...
    if(eventType == "Signal"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs("LooseSignalEE_EpsilonsTest.pdf");      
    }
    ...
    if(eventType == "Wlike"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs("LooseWlikeEE_EpsilonsTest.pdf");      
    }
    ...
    if(eventType == "QCDlike"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs("LooseQCDEE_EpsilonsTest.pdf");      
    }
