MatrixMethod_Results_EE(string selection, string eventType, string ntupleType, string fast, string other){
  ...
  TFile * file_Expected   = new TFile(("MatrixMethod_OutPut_EECase_MC"+other+".root").c_str());
  TFile * file_Estimated  = new TFile(("MatrixMethod_OutPut_EECase"+ntupleType+fast+other+".root").c_str());
  ...
  TH1F* tight_ZJets  = (TH1F*)gROOT->FindObject("MMExpected_TightEE_Zjets");
  TH1F* medium_ZJets = (TH1F*)gROOT->FindObject("MMExpected_MediumEE_Zjets");
  TH1F* loose_ZJets  = (TH1F*)gROOT->FindObject("MMExpected_LooseEE_Zjets");
  ...
  TH1F* tight_DYHigh  = (TH1F*)gROOT->FindObject("MMExpected_TightEE_DYToEE_M-20");
  TH1F* medium_DYHigh = (TH1F*)gROOT->FindObject("MMExpected_MediumEE_DYToEE_M-20");
  TH1F* loose_DYHigh  = (TH1F*)gROOT->FindObject("MMExpected_LooseEE_DYToEE_M-20");
  ...
  TH1F* tight_DYLow  = (TH1F*)gROOT->FindObject("MMExpected_TightEE_DYToEE_M-10To20");
  TH1F* medium_DYLow = (TH1F*)gROOT->FindObject("MMExpected_MediumEE_DYToEE_M-10To20");
  TH1F* loose_DYLow  = (TH1F*)gROOT->FindObject("MMExpected_LooseEE_DYToEE_M-10To20");
  ...
  TH1F* tight_DYTauTauHigh  = (TH1F*)gROOT->FindObject("MMExpected_TightEE_DYToTauTau_M-20");
  TH1F* medium_DYTauTauHigh = (TH1F*)gROOT->FindObject("MMExpected_MediumEE_DYToTauTau_M-20");
  TH1F* loose_DYTauTauHigh  = (TH1F*)gROOT->FindObject("MMExpected_LooseEE_DYToTauTau_M-20");
  ...
  TH1F* tight_DYTauTauLow  = (TH1F*)gROOT->FindObject("MMExpected_TightEE_DYToTauTau_M-10To20");
  TH1F* medium_DYTauTauLow = (TH1F*)gROOT->FindObject("MMExpected_MediumEE_DYToTauTau_M-10To20");
  TH1F* loose_DYTauTauLow  = (TH1F*)gROOT->FindObject("MMExpected_LooseEE_DYToTauTau_M-10To20");
  ...
  TH1F* tight_WJets  = (TH1F*)gROOT->FindObject("MMExpected_TightEE_Wjets");
  TH1F* medium_WJets = (TH1F*)gROOT->FindObject("MMExpected_MediumEE_Wjets");
  TH1F* loose_WJets  = (TH1F*)gROOT->FindObject("MMExpected_LooseEE_Wjets");
  ...
  TH1F* tight_TtW  = (TH1F*)gROOT->FindObject("MMExpected_TightEE_TtW");
  TH1F* medium_TtW = (TH1F*)gROOT->FindObject("MMExpected_MediumEE_TtW");
  TH1F* loose_TtW  = (TH1F*)gROOT->FindObject("MMExpected_LooseEE_TtW");
  ...
  TH1F* tight_TbartW  = (TH1F*)gROOT->FindObject("MMExpected_TightEE_TbartW");
  TH1F* medium_TbartW = (TH1F*)gROOT->FindObject("MMExpected_MediumEE_TbartW");
  TH1F* loose_TbartW  = (TH1F*)gROOT->FindObject("MMExpected_LooseEE_TbartW");
  ...
  TH1F* tight_WW  = (TH1F*)gROOT->FindObject("MMExpected_TightEE_WW");
  TH1F* medium_WW = (TH1F*)gROOT->FindObject("MMExpected_MediumEE_WW");
  TH1F* loose_WW  = (TH1F*)gROOT->FindObject("MMExpected_LooseEE_WW");
  ...
  TH1F* tight_WZ  = (TH1F*)gROOT->FindObject("MMExpected_TightEE_WZ");
  TH1F* medium_WZ = (TH1F*)gROOT->FindObject("MMExpected_MediumEE_WZ");
  TH1F* loose_WZ  = (TH1F*)gROOT->FindObject("MMExpected_LooseEE_WZ");
  ...
  TH1F* tight_ZZ  = (TH1F*)gROOT->FindObject("MMExpected_TightEE_ZZ");
  TH1F* medium_ZZ = (TH1F*)gROOT->FindObject("MMExpected_MediumEE_ZZ");
  TH1F* loose_ZZ  = (TH1F*)gROOT->FindObject("MMExpected_LooseEE_ZZ");
  ...
  if( selection == "Tight"){
    ...
    if(eventType == "Signal"){
      TCanvas * canv = new TCanvas(("canvEE"+selection+eventType+ntupleType+fast+other).c_str(), ("canvEE"+selection+eventType+ntupleType+fast+other).c_str(), 600, 800);
      ...
      qw->Draw("same");
      canv->SaveAs(("TightSignalEE"+ntupleType+fast+other+".pdf").c_str());
    }
    ...
    if(eventType == "Wlike"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs(("TightWlikeEE"+ntupleType+fast+other+".pdf").c_str());
    }
    ...
    if(eventType == "QCDlike"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs(("TightQCDEE"+ntupleType+fast+other+".pdf").c_str());      
    }
  ...
  if( selection == "Medium"){
    ...
    if(eventType == "Signal"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs(("MediumSignalEE"+ntupleType+fast+other+".pdf").c_str());
    }
    ...
    if(eventType == "Wlike"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs(("MediumWlikeEE"+ntupleType+fast+other+".pdf").c_str());      
    }
    ...
    if(eventType == "QCDlike"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs(("MediumQCDEE"+ntupleType+fast+other+".pdf").c_str());      
    }
  ...
  if( selection == "Loose"){
    ...
    if(eventType == "Signal"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs(("LooseSignalEE"+ntupleType+fast+other+".pdf").c_str());      
    }
    ...
    if(eventType == "Wlike"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs(("LooseWlikeEE"+ntupleType+fast+other+".pdf").c_str());      
    }
    ...
    if(eventType == "QCDlike"){
      ...
      qw->Draw("same");
      title->Draw("same");
      canv->SaveAs(("LooseQCDEE"+ntupleType+fast+other+".pdf").c_str());      
    }
