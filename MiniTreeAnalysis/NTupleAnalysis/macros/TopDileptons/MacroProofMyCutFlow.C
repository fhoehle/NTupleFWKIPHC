...
int main(int argc, char* argv[]){
 ...
 string xmlFileName = string("/opt/sbg/data/data1/cms/jandrea/TopIPHC_2012_01_25/CMSSW_4_2_8_patch7/src/MiniTreeAnalysis/NTupleAnalysis/config/MyCutFlow.xml");  
