...
int main ()
{
  ...
  string xmlFileName = string ("../../config/MatrixMethod_MC_forNoWeight.xml");
  ...
  //////////////////////////////////////////
  MMestEE.ReadMMFileForPullTest("MatrixMethod_OutPut_EECase_MC_NoWeight.root", 0.95, 0.2);
  MMestMuMu.ReadMMFileForPullTest("MatrixMethod_OutPut_MuMuCase_MC_NoWeight.root", 0.95, 0.2);
  ...
  MMestEE.WriteMMFileFastForPullTest("MatrixMethod_OutPut_EECase_MC_NoWeight.root","MatrixMethod_OutPut_EECase_MC_Fast_EpsilonsTest.root", 0.95, 0.2);
  ...
  MMestMuMu.WriteMMFileFastForPullTest("MatrixMethod_OutPut_MuMuCase_MC_NoWeight.root","MatrixMethod_OutPut_MuMuCase_MC_Fast_EpsilonsTest.root", 0.95, 0.2);
