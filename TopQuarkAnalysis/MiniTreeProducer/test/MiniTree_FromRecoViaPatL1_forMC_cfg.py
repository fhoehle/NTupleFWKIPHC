...
process.ak5CaloResidual.useCondDB = True
process.ak5PFResidual.useCondDB   = True
process.ak5JPTResidual.useCondDB  = True
...
process.source = cms.Source(
	...
	fileNames = cms.untracked.vstring(
	       #"file:1A85A092-63D9-DF11-97CF-0026B9278603.root"
		'file:/opt/sbg/cms/ui4_data1/lebihan/TTJets_TuneD6T_7TeV-madgraph-tauola_START38_V12-v1_gen-sim-reco.root'
	)
)
