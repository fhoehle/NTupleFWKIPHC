 	...
 	hltTausMatcher45    = cms.string("tauMatchHLTTaus45"),  
        ...
        #rho_PUUE_dens      = cms.InputTag("kt6CaloJets", "rho"),
            ...
            jetmetProducer      = cms.VPSet(
	    				...
	    				cms.PSet(jet = cms.untracked.string("selectedPatJetsPF2PAT"), met = cms.untracked.string("patMETsTypeIIPF"), algo =cms.untracked.string("pfType2"))
                                )
    )
...
process.patMETsTypeIIPF = process.patMETsPF2PAT.clone(
        metSource = cms.InputTag("metJESCorAK5PFTypeII")
    )
