...
from TopQuarkAnalysis.MiniTreeProducer.simpleCutBasedElectronIDSpring10_cfi import *
...
cicVeryLoose   = eidVeryLoose.clone()
cicLoose       = eidLoose.clone()
cicMedium      = eidMedium.clone()
cicTight       = eidTight.clone()
cicSuperTight  = eidSuperTight.clone()
cicHyperTight1 = eidHyperTight1.clone()
cicHyperTight2 = eidHyperTight2.clone()
cicHyperTight3 = eidHyperTight3.clone()

from RecoEgamma.ElectronIdentification.cutsInCategoriesElectronIdentificationV06_cfi import *
cicVeryLooseMC   = eidVeryLooseMC.clone()
cicLooseMC       = eidLooseMC.clone()
cicMediumMC      = eidMediumMC.clone()
cicTightMC       = eidTightMC.clone()
cicSuperTightMC  = eidSuperTightMC.clone()
cicHyperTight1MC = eidHyperTight1MC.clone()
cicHyperTight2MC = eidHyperTight2MC.clone()
cicHyperTight3MC = eidHyperTight3MC.clone()
